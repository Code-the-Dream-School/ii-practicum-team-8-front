        ...
        <div className="footer-content">
          <div className="footer-section about">
            ...
            <h2 className="footer-heading"> Follow Us</h2>
              <a href="https://facebook.com" aria-label="Facebook" target="_blank" rel="">
                <FacebookOutlinedIcon className="icon" />
              </a>
              <a href="https://instagram.com" aria-label="Instagram" target="_blank" rel="">
                <InstagramIcon className="icon" />
              </a>
              <a href="https://twitter.com" aria-label="Twitter" target="_blank" rel="">
                <TwitterIcon className="icon" />
              </a>
              <a href="https://youtube.com" aria-label="YouTube" target="_blank" rel="">
